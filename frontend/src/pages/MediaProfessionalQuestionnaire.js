  ...
  const sectionData = [
    {
      ...
      questions: [
        ...
        { field: 'role', question: 'Current managerial role:', type: 'radio', options: ['Editor or Managing Editor', 'News Director', 'Producer or Executive Producer', 'Content or Platform Manager', 'Station or Organisation Head', 'Other managerial role'], otherField: 'roleOther', otherLabel: 'Role (please specify)', otherTrigger: 'Other managerial role' },
        ...
        { field: 'coverageLanguages', question: 'Which language(s) are mostly used in your organisation coverage?', type: 'checkbox', options: ['English', 'Pidgin', 'Hausa', 'Yoruba', 'Igbo', 'Other Nigerian languages'], otherField: 'coverageLanguagesOther', otherLabel: 'Please specify', required: false }
      ]
    },
    {
      ...
      questions: [
        ...
        { field: 'complaintsFreq', question: 'How often does your organisation receive audience complaints or correction requests?', type: 'radio', options: ['Very often', 'Often', 'Sometimes', 'Rarely', 'Never'] },
        ...
        { field: 'vulnerableAreas', question: 'Which content areas are most vulnerable to falsehoods?', type: 'checkbox', options: ['Political reporting', 'Election-related coverage', 'Security and conflict reporting', 'Health and science coverage', 'Ethnic or religious issues'] },
        { field: 'collaborationFreq', question: 'How frequently does your organisation collaborate with fact-checking organisations?', type: 'radio', options: ['Very often', 'Often', 'Sometimes', 'Rarely', 'Never'] }
      ]
    },
    {
      ...
      questions: [
        ...
        { field: 'emphasiseAccuracyFreq', question: 'How often does your organisation emphasise accuracy and verification in published content?', type: 'radio', options: ['Very often', 'Often', 'Sometimes', 'Rarely', 'Never'] },
