  ...
  const sectionData = [
    {
      ...
      questions: [
        ...
        { field: 'favouriteOAPs', question: '15. If yes, list up to five OAPs. Provide name and handle or URL.', type: 'text', multiline: true, required: false },
        { field: 'favouriteInfluencers', question: '16. If yes, list up to five Social Media Influencers. Provide name and handle or URL.', type: 'text', multiline: true, required: false },
        ...
        { field: 'sharedFromFavoritesFreq', question: '18. If yes, how often?', type: 'radio', options: ['Rarely', 'Sometimes', 'Often', 'Always'], required: false },
    ...
    },
    {
      ...
      questions: [
        ...
        { field: 'sharedFalseDescribe', question: '31. If yes, please describe:', type: 'text', multiline: true, required: false },
        ...
        { field: 'impactedNationalViewDetails', question: '38. If yes, please provide details:', type: 'text', multiline: true, required: false },
        ...
        { field: 'reportedFalseInfoReason', question: '47. If yes, what was the reason for reporting it?', type: 'checkbox', options: ['To prevent others from being misled', 'Because the content was harmful', 'Because it violated platform rules', 'Because it targeted individuals or groups', 'Other'], otherField: 'reportedFalseInfoReasonOther', otherLabel: 'Please specify', required: false },
    ...
    },
    {
      ...
      questions: [
        ...
        { field: 'familiarAIList', question: '68. If yes, please list:', type: 'text', multiline: true, required: false },
