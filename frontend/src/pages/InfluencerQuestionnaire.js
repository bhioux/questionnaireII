  ...
  const sectionData = [
    ...
    },
    {
      ...
      questions: [
        ...
        { field: 'platformFactors', question: 'Which platform-related factors influence your decision to share content?', type: 'checkbox', options: ['Expected audience engagement', 'Trending topics/hashtags', 'Algorithm visibility or reach', 'Monetization or brand partnerships', 'Other'], otherField: 'platformFactorsOther', otherLabel: 'Please specify' },
